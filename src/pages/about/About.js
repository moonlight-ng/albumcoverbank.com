    ...
    <div className={classes.about}>
      <div className={classes.aboutWrapper}>
        <section>
          ...
          <p>This project is supported by Independent Arts, a creative incubator dedicated to nurturing Nigerian artistry.</p>
        </section>
        <section>
          <h3>Essays</h3>
          <p>
